...
class StudentController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->filled('search')) {
            ...
            $query->where(function ($q) use ($search) {
                ...
                ->orWhere('schooltype', 'like', "%{$search}%");
            });
        }
    ...
    public function edit($id)
    {
        ...
        $classes = ['ADMIN','SUPPORT STAFF','CRECHE', 'PREP CAT2','KG 1 CAT2','KG 2 CAT2','NUR 1 CAT2','NUR 2 CAT2','GRADE 1 CAT2','GRADE 2 CAT2','GRADE 3 CAT2','GRADE 4 CAT2','GRADE 5 CAT2','JSS 1 CAT2','JSS 2 CAT2','JSS 3 CAT2','SSS 1 CAT2','SSS 2 CAT2','SSS 3 CAT2','PREP','KG 1','KG 2','NURSERY 1','NURSERY 2','GRADE 1','GRADE 2','GRADE 3','GRADE 4','GRADE 5','GRADE 6',
